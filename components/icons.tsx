...
export const ChatBubbleLeftRightIcon: React.FC<IconProps> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M20.25 8.511c.884.284 1.5 1.128 1.5 2.097v4.286c0 1.136-.847 2.1-1.98 2.193l-3.722.537a5.25 5.25 0 0 1-3.498-1.584l-3.218-3.218a5.25 5.25 0 0 1-1.584-3.498L6.22 6.489a2.1 2.1 0 0 1 2.193-1.98l4.286.002c.97.001 1.813.615 2.097 1.5Z" />
    <path strokeLinecap="round" strokeLinejoin="round" d="M3.75 12a1.5 1.5 0 1 1-3 0 1.5 1.5 0 0 1 3 0Zm0-3.75a1.5 1.5 0 1 1-3 0 1.5 1.5 0 0 1 3 0Zm0 7.5a1.5 1.5 0 1 1-3 0 1.5 1.5 0 0 1 3 0Z" />
  </svg>
);
...
export const GlobeAltIcon: React.FC<IconProps> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    ...
    <path strokeLinecap="round" strokeLinejoin="round" d="M3.75 12h16.5m-16.5 0c0 5.25 4.186 9.375 9.375 9.375s9.375-4.125 9.375-9.375m-18.75 0c0-5.25 4.186-9.375 9.375-9.375s9.375 4.125 9.375 9.375" />
  </svg>
);

export const PaintBrushIcon: React.FC<IconProps> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M9.53 16.122a3 3 0 0 0-5.78 1.128 2.25 2.25 0 0 1-2.47 2.118 2.25 2.25 0 0 1-2.47-2.118c0-.62.28-1.186.74-1.585l5.78-5.78a3 3 0 0 0 4.242 0l4.242-4.242a3 3 0 0 1 4.242 0l-5.78 5.78a3 3 0 0 0 0 4.242l2.121 2.121a3 3 0 0 1 0 4.242l-5.78 5.78a3 3 0 0 1-4.242 0l-2.121-2.121a3 3 0 0 0-4.242 0Z" />
  </svg>
);
